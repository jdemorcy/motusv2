  ...
  ShowResult(BuildContext context, bool victory, String wordSmallCaps) {
    ...
    Widget wikiButton = TextButton(
      ...
      onPressed: () async {
        ...
        await launch(
            url); // requires a modification in AndroidManifest.xml in order to work
      },
    );
    ...
    AlertDialog alertPlayerWins = AlertDialog(
      ...
      content: Text(
          "Vous avez trouvé ! '$wordSmallCaps' était bien le mot recherché ! \n\nCliquez sur 'OK' pour démarrer une nouvelle partie"),
      actions: [
        wikiButton,
        okButton,
      ],
    ...
    AlertDialog alertPlayerLoses = AlertDialog(
      title: const Text("Pas de chance..."),
      content: Text(
          "Le mot recherché était: '$wordSmallCaps'... \n\nCliquez sur 'OK' pour démarrer une nouvelle partie."),
      actions: [
        wikiButton,
        okButton,
      ],
